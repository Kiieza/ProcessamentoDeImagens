...
let suavizacaoMediana = function() {
    ...
    for (var i = 1; i < img.width+1; i++) {       
        for (var j = 1; j < img.height+1; j++) {   
            ...
            px.push(rgbToHsl(img.getPixel(i,j))); //Pixel Central
            px.push(rgbToHsl(img.getPixel(i,j+1)));
            px.push(rgbToHsl(img.getPixel(i+1,j-1)));
            px.push(rgbToHsl(img.getPixel(i+1,j)));
            px.push(rgbToHsl(img.getPixel(i+1,j-1)));
...
document.getElementById('btnLoad').addEventListener('click', carregarC);
document.getElementById('btnDesfoqueGaussiano').addEventListener('click', desfoqueGaussian);
document.getElementById('btnMean').addEventListener('click', suavizacaoMediana);
document.getElementById('btnMedian').addEventListener('click', suavizacaoMedia);
document.getElementById('btnGray').addEventListener('click', mediaCinza);
document.getElementById('btnGrayNTSC').addEventListener('click', ntscCinza);
document.getElementById('btnBinarizacao').addEventListener('click', binarizacao);
document.getElementById('btnRotar90').addEventListener('click', rotation90);
document.getElementById('btnRotar180').addEventListener('click', rotation180);
document.getElementById('btnRotar270').addEventListener('click', rotation270);
